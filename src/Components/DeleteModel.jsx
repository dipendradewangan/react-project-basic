...
const DeleteModel = () => {
    ...
    const { setModelStatus, modelType, setModelType} = useContext(TaskDataContext)
    return (
        <div className='w-[300px] border-0 border-yellow-100 bg-gray-700 rounded-lg'>
            ...
            <div className='flex gap-2 justify-center px-3 py-2 border-t border-gray-800 text-black'>
                <button onClick={()=>(setModelStatus('Close'), setModelType(''))} className='bg-red-600 px-3 font-semibold text-blue-950 rounded cursor-pointer hover:bg-red-500'>Delete</button>
